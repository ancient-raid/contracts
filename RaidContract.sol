...
// File: node_modules\@openzeppelin\contracts-upgradeable\access\IAccessControlEnumerableUpgradeable.sol
...
// File: node_modules\@openzeppelin\contracts-upgradeable\utils\structs\EnumerableSetUpgradeable.sol
    ...
    IERC20MetadataUpgradeable
{
    ...
    bool private openTransfered = false;

    address public mainWallte;
    address public zhiWallte;
    address public rewardWallte;

    function udpateUniswapV2PairAddress(address _uniswapV2PairAddress)
        internal
        virtual
    {
    ...
    function udpateTransfered(bool _is) internal virtual {
        openTransfered = _is;
    }

    function udpateMainWallte(
        address _mainWallte,
        address _zhiWallte,
...
// File: node_modules\@theanthill\pancake-swap-periphery\contracts\interfaces\IPancakeRouter01.sol
...
// File: @theanthill\pancake-swap-periphery\contracts\interfaces\IPancakeRouter02.sol
...
// File: contracts\V1\Oracle\PancakeLibrary.sol
...
// File: RaidContract.sol

pragma solidity 0.8.9;

contract RaidContract is
    Initializable,
    ContextUpgradeable,
    OwnableUpgradeable,
    UUPSUpgradeable,
